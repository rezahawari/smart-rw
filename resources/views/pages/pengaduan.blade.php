                        ...
                        <div class="nftmax-pcats">
                            ...
                            <div class="nftmax-pcats__bar">
                                <div class="nftmax-pcats__list list-group " id="list-tab" role="tablist">
                                    <a class="list-group-item active" data-bs-toggle="list" href="#tab_1" role="tab" href="profile.html">Daftar Pengaduan Warga</a>
                                            ...
                                            <table id="nftmax-table__main tabel1" class="table table-striped nftmax-table__main nftmax-table__profile-activity">
                                                ...
                                                <thead class="nftmax-table__head">
                                                    <tr>
                                                        ...
                                                        <th class="nftmax-table__column-3 nftmax-table__h2">Judul</th>
                                                        <th class="nftmax-table__column-2 nftmax-table__h2">Deskripsi Pelaporan</th>
                                                        <th class="nftmax-table__column-3 nftmax-table__h2">Pelapor</th>
                                                        <th class="nftmax-table__column-4 nftmax-table__h3">Alamat</th>
                                                        <th class="nftmax-table__column-5 nftmax-table__h4">Status Pelaporan</th>
                                                        <th class="nftmax-table__column-6 nftmax-table__h5">Tanggal Pelaporan</th>
                                                ...
                                                <tbody class="nftmax-table__body">
                                                    <tr>
                                                        ...
                                                        <td class="nftmax-table__column-2 nftmax-table__data-2">
                                                            <p class="nftmax-table__text nftmax-table__bid-text">Parkir mobil tidak sesuai tempatnya</p>
                                                        </td>
                                                        <td class="nftmax-table__column-3 nftmax-table__data-3">
                                                            <p class="nftmax-table__text nftmax-table__bid-text">ada mobil warna hitam yang parkir sembarangan di depan rumah</p>
                                                        </td>
                                                        <td class="nftmax-table__column-3 nftmax-table__data-3">
                                                        ...
                                                        <td class="nftmax-table__column-5 nftmax-table__data-5">
                                                            <p class="nftmax-table__text nftmax-table__bid-text">Dikirim</p>
                                                        </td>
